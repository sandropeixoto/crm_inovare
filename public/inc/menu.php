...
<div class="sidebar d-flex flex-column">
  ...
  <a href="../clientes/listar.php" class="<?= str_contains($path,'clientes')?'active':'' ?>">👥 Clientes</a>
  <a href="../propostas/listar.php" class="<?= str_contains($path,'propostas')?'active':'' ?>">📄 Propostas</a>

  <?php if(in_array($user['perfil'], ['admin','gestor'])): ?>
    <a href="../usuarios/listar.php" class="<?= str_contains($path,'usuarios')?'active':'' ?>">🧑‍💼 Usuários</a>
    <a href="../configuracoes/editar.php" class="<?= str_contains($path,'configuracoes')?'active':'' ?>">⚙️ Configurações</a>
      ...
      <div class="accordion-item border-0 bg-transparent">
        ...
        <div id="collapseAux" class="accordion-collapse collapse <?= str_contains($path,'auxiliares')?'show':'' ?>" aria-labelledby="headingAux">
          <div class="accordion-body p-0">
            <a href="../auxiliares/pacotes.php" class="ps-5 py-2 d-block text-white <?= str_contains($path,'pacotes')?'active':'' ?>">📦 Pacotes</a>
            <a href="../auxiliares/status_proposta.php" class="ps-5 py-2 d-block text-white <?= str_contains($path,'status_proposta')?'active':'' ?>">📊 Status Proposta</a>
            <a href="../auxiliares/classificacoes.php" class="ps-5 py-2 d-block text-white <?= str_contains($path,'classificacoes')?'active':'' ?>">🏷️ Classificações</a>
            <a href="../auxiliares/unidades_medida.php" class="ps-5 py-2 d-block text-white <?= str_contains($path,'unidades_medida')?'active':'' ?>">📐 Unidades de Medida</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- Script para funcionamento do acordeão -->
